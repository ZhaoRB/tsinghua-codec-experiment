...
# 4. draw
whiteImage = cv2.imread("/Users/riverzhao/Project/Codec/3_experiment/tsinghua-codec-experiment/data/whiteImage/0.2m.bmp")
cornerCenterPath = os.path.join(
    projectPath, f"./data/corner-center/white.png"
)
allCenterPath = os.path.join(projectPath, f"./data/all-center/white.png")
