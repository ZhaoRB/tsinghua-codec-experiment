...
def main() : 
    patterns = {0:[1,7,13,19,25],1:[11,16,22,23,24,25,20,15,10,5], 2:[3,4,9,10,15,20,19,24,23,22,21], 3:[1,7,13,19,25,19,13,7,1], 4:[1,2,3,9,15,20,25], 5:[1,2,3,4,5,10,9,8,7,6,11,12,13,14,15,20,19,18,17,16,21,22,23,24,25]}
    p = 0
    args = parse_arg()
    if args.pattern :
