...
if __name__ == "__main__":
    input_folder = "/mnt/e/ZRB/0822"
    output_folder = "/mnt/e/ZRB/0822-fix-color"
    ...
    for i in range(300):  # 遍历 image000.bmp 到 image299.bmp
        idx = i + 1
        image_name = f"Image{idx:03d}.bmp"
        ...
        if os.path.exists(input_path):
            ...
            # 进行图像调整
            image = adjustColorBalance(raw_image, 1.05, 0.95, 0.95)
            image = adjustBrightnessSmooth(image, 1, 1.7, 20, 200)
            image = adjustColor(image, 1.2)
